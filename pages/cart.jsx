...
import { reset } from "../redux/cartSlices";
  ...
  const createOrder = async (data) => {
    try {
      const res = await axios.post(
        "https://delivery-food-yukari.vercel.app/api/orders",
        data
      );
      if (res.status === 201) {
        dispatch(reset());
          ...
          {open ? (
            <div className={styles.paymentMethods}>
              ...
              <PayPalScriptProvider
                options={{
                  "client-id":
                    "AfeWPUHYbz4ngGqeO_1HTqwBqD6RqB33n2dzXvVrCiqjPw39CS6MnDImdGpcELsjiuTenV-LN01ZDXuH",
                  components: "buttons",
                  currency: "USD",
